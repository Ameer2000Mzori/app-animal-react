...
> App-Animal-React is a project created with React.js and TailwindCSS, using Prettier to make the code cleaner. In this project, each time you click the button, a random animal image will appear on the screen, and you can like it. Download the project and have a look, or check the sample images.
